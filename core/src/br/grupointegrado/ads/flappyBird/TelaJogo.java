...
/**
 * Created by Laydi on 28/09/2015.
 */
public class TelaJogo extends TelaBase {
    ...
    private void initFontes() {
      ...
      // fonteParam.shadowColor = Color.BLACK;
        fonteParam.color = com.badlogic.gdx.graphics.Color.WHITE;
        fonteParam.shadowColor = com.badlogic.gdx.graphics.Color.BLACK;
    ...
    private void renderizar(float delta) {
        ...
        pincel.draw(texturaFundo, 0, 0,
                cameraInf.viewportWidth, cameraInf.viewportHeight);
